...
describe("Customer", () => {
    it("should create customer", () => {
        ...
        let addressesList = [ new Address("addressLine", "addressLine2", "addressType", "city", "123456", "state", "country") ]
        let notes = [ "123" ]

        let customer = new Customer(firstName, lastName, phoneNumber, email, totalPurchasesAmount, lastPurchaseDate, addressesList, notes)
